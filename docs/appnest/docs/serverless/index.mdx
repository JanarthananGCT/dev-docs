...
![image-8](https://static.surveysparrow.com/application/marketplace/ssdk-assets/image8.png)

![image-9](https://static.surveysparrow.com/application/marketplace/ssdk-assets/image9.png)
...
3. When you want to import and use any NPM packages within the server folder, please add the NPM packages as dependencies in the manifest.json.
