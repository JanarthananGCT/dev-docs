...
Before exploring the next sections, make sure to install the [SSDK CLI](https://sdk.surveysparrow.dev/docs/getting-started/quick-start.html).
...
about the app. It also serves as the overall appâ€™s configuration.
...
Ta da ðŸŽ‰! You can build apps for various events to push data to other 3rd party integration. Please refer documentation for reference.
