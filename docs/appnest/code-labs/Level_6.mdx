...
Once youâ€™re ready with your developed app, you can proceed to submit it for review. SurveySparrowâ€™s App Review team will examine the application to make sure it adheres to the set guidelines of the SurveySparrow AppNest. Upon successful review of your application, the app will be approved and published on the SurveySparrow AppNest.
...
- Fill in the required fields so that it becomes a smooth onboarding process for the users.
  ...
  #### Uploading App icon
      The appâ€™s icon should be 400 x 400 pixels. Ensure that the image is in one of the following formats: JPG, JPEG, or PNG.
...
If you want to publish public app, please contact SurveySparrowâ€™s App Review team and provide your app id and app name through support chat or community.
Upon submitting the app, SurveySparrowâ€™s App Review team will examine and analyze it. Upon successful review, your app will be published on SurveySparrowâ€™s AppNest.
