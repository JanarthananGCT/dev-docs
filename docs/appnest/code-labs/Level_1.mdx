...
sidebar_position: 3
hide_title: false
sidebar_label: Level 1 - Simple SSDK App
title: Level 1 - Simple SSDK App
id: simple_sdk_app
slug: appnest/code-labs/simple_sdk_app
---
...
In this tutorial, we will create a simple app to understand SurveySparrow AppNestâ€™s application structure.
...
- The latest version of the [SurveySparrow CLI (SSDK)](/appnest/docs/Appnest) installed.
...
Letâ€™s learn how to run the AppNest app in your local.
...
Installation Parameters are values that are collected during the appâ€™s installation. In this app, we are collecting API keys. Navigate to the config folder. Open the iparams.json file and add the following JSON code.
...
This app will create a survey with the click of the <strong>Create</strong> button. Letâ€™s code together in this tutorial.
